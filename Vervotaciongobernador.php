...
<head>
<meta charset="utf-8">
<title>Solor-Ver votacion Gobernador</title>
...
<div id="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Vista Resumén Votación Gobernador</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <section id="content">
                ...
                <form action="Registroalcalde.php" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    $img=$fconsultagobernador[8];
                        $votos=mysqli_query($cnx,"SELECT pp.descripcion,pp.logo,dv.cantidadvoto,pp.color FROM votacion v,detallevotacion dv, partidopolitico pp
                                ...
                                AND v.idvotacion=$fconsultagobernador[0]
                                ORDER BY dv.iddetallevoto");
                            ?>
                    <label><strong><big>Detalle de votos para GOBERNADOR(A)<strong></big></label>
        ...
        ?>
                    ...
                    <a <?php echo "href='grafics/GraficoGoberMesa.php?idmesa=$idmesa'";?> class="btn btn-large btn-success"> <i class="fa fa-signal"></i></i> Ver Gráfico Estadístico</a>
                    </div>
        <?php
            }
        ?>
