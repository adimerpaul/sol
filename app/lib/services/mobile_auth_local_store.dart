...
class MobileAuthLocalStore {
  ...
  Future<List<_PreloadedDraft>> _buildPreloadedDrafts(
    ...
    for (final mesa in data.mesas) {
      ...
      final votos = res.detalles
          .map(
            (d) => {
              ...
              'nombre': '',
              'icono_url': null,
              'votos_gobernador': d.votosGobernador,
              'votos_asambleista_distrito': d.votosAsd,
              'votos_asambleista_poblacion': d.votosAsp,
      ...
      final payload = {
        ...
        'observacion_gobernador': res.observacionGobernador,
        'observacion_asambleista_distrito': res.observacionAsd,
        'observacion_asambleista_poblacion': res.observacionAsp,
        'observacion_concejal': res.observacionConcejal,
  ...
  Future<void> saveVotacionDraft(
    ...
    final payload = {
      ...
      'observacion_gobernador': draft.observacionGobernador,
      'observacion_asambleista_distrito': draft.observacionAsd,
      'observacion_asambleista_poblacion': draft.observacionAsp,
      'observacion_concejal': draft.observacionConcejal,
  ...
  Future<VotacionDraft?> readVotacionDraft(int mesaId) async {
    ...
    return VotacionDraft(
      ...
      observacionAsp: payload['observacion_asambleista_poblacion']?.toString(),
      observacionConcejal: payload['observacion_concejal']?.toString(),
