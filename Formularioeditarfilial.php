...
<head>
<meta charset="utf-8">
<title>Solor-Editar Filial</title>
...
<div id="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li><a href="#">Editar</a><i class="icon-angle-right"></i></li>
					<li class="active">Editar datos Filial</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<?php
	$ci=$_GET['ci'];
	$filial=mysqli_query($cnx,"SELECT * FROM filial WHERE ci=$ci");
		...
		<div class="container">
			<div class="row">
			    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
					<form role="form" class="register-form" action="Editarfilial.php" method="POST">
					<input type="hidden" name="cifilial" <?php echo "value='$ci'";?>>
						<h2>Por favor edite <small>en este formulario la información del filial.</small></h2>
						<hr class="colorgraph">
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-6">
								<div class="form-group">
			                        <input type="text" name="ci" id="ci" class="form-control input-lg" placeholder="Carnet de identidad" tabindex="1" style="text-transform:uppercase;" <?php echo "value='$ffilial[0]'"; ?> required>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-6">
								<div class="form-group">
								<input type="text" name="apellidopat" id="apellidopat" class="form-control input-lg" placeholder="Apellido Paterno" tabindex="1" style="text-transform:uppercase;" <?php echo "value='$ffilial[1]'"; ?> required>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6">
								<div class="form-group">
								<input type="text" name="apellidomat" id="apellidomat" class="form-control input-lg" placeholder="Apellido Materno" tabindex="1" style="text-transform:uppercase;" <?php echo "value='$ffilial[2]'"; ?> required>
								</div>
							</div>
						</div>
						<div class="form-group">
							<input type="text" name="nombre" id="nombre" class="form-control input-lg" placeholder="NOMBRE(S)" tabindex="4" style="text-transform:uppercase;" <?php echo "value='$ffilial[3]'"; ?> required>
						</div>
						<div class="row">
							<div class="col-xs-12 col-sm-6 col-md-6">
								<div class="form-group">
									<input type="number" name="cel" id="cel" class="form-control input-lg" placeholder="NUMERO TELEFONICO" tabindex="5" <?php echo "value='$ffilial[4]'"; ?> required>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6">
								<div class="form-group">
									<input type="number" name="edad" id="edad" class="form-control input-lg" placeholder="EDAD" tabindex="6" required min="18" max="50" <?php echo "value='$ffilial[5]'"; ?>>
								</div>
							</div>
						</div>
						<hr class="colorgraph">
