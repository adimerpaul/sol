                    ...
                    <h4>Mesas de votación <strong> encontradas</strong></h4>
                        ...
                        <div class="pricing-content">
                          ...
                          if ($_SESSION['usr']=='FJR065'){
                              ...
                              $mesa=mysqli_query($cnx,"SELECT * FROM mesa WHERE idrecinto=$idrecinto AND nummesa BETWEEN $ffilial[7] AND $ffilial[8] ORDER BY idmesa");
                          }
                          while ($fmesa=mysqli_fetch_array($mesa)) {
                          ?>
                            <li><i class="icon-ok"></i><h1><strong> MESA #<?php echo($fmesa[2]); ?></strong></h1>
                            <a <?php echo("href='IniciarvotacionA.php?idmesa=$fmesa[0]&idrecinto=$idrecinto&tipo=A'"); ?>  class="btn btn-lg btn-warning"><i class="icon-bolt"></i> Votación Alcaldes/Concejales</a><br><br>
                            <a <?php echo("href='IniciarvotacionG.php?idmesa=$fmesa[0]&idrecinto=$idrecinto&tipo=G'"); ?>  class="btn btn-lg btn-theme"><i class="icon-bolt"></i> Votación Gobernadores/Asambleistas</a>
                            <?php  
                          }
                            ?>
                          </ul>
