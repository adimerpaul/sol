                    ...
                    <h4>Mesas de votación <strong> encontradas</strong></h4>
                        ...
                        <div class="pricing-content">
                          ...
                          ?>
                            ...
                            <a <?php echo("href='IniciarvotacionA.php?idmesa=$fmesa[0]&idrecinto=$idrecinto&tipo=A'"); ?>  class="btn btn-lg btn-warning"><i class="icon-bolt"></i> Registrar Votos Alcaldes/Concejales</a><br><br>
                            <a <?php echo("href='IniciarvotacionG.php?idmesa=$fmesa[0]&idrecinto=$idrecinto&tipo=G'"); ?>  class="btn btn-lg btn-theme"><i class="icon-bolt"></i> Registrar Votos Gobernadores/Asambleistas</a>
                            <?php  
                          }
                            ?>
                          </ul>
