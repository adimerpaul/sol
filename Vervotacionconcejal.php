...
<head>
<meta charset="utf-8">
<title>Solor-Ver votacion Concejal</title>
...
<div id="wrapper">
    ...
    <section id="content">
        ...
        ?>
                    ...
                    <a <?php echo "href='grafics/GraficoConcejalMesa.php?idmesa=$idmesa'";?> class="btn btn-large btn-success"> <i class="fa fa-signal"></i></i> Ver Gráfico Estadístico</a>
                    </div>
        <?php
        }
        ?>
