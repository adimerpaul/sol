			    ...
			    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                    ...
                    while ($fvotaciones=mysqli_fetch_array($votaciones)) {
                            echo "<tr>
                                ...
                                <td width=100><a href='".$fvotaciones[4]."' target='_blank'><img style='max-width: 100%; height: auto;' src='$fvotaciones[4]' class='img-fluid img-thumbnail' alt='Responsive image'/></a></td>";
                                if ($fvotaciones[5]=='T') {
