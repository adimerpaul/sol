...
if($_SESSION['usr']!="")
{
 include ("header.php");?>
	...
	<section id="content">
		<div class="container">
			<form role="form" class="register-form" action="grafics/GraficoGoberProvincia.php" method="POST">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div class="form-group">
						<button type="submit" class="form-control input-lg btn-round btn-success" name="ok" ><i class="fa fa-signal"></i> GENERAR GRÁFICO GOBERNADOR</button>
						</div>
					</div>
				</div>
				<hr class="colorgraph">
